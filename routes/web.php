...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('staff')->name('staff.')->group(function () {
        ...
        // Route::get('/appraisals', \App\Livewire\Staff\Appraisals\Index::class)->name('appraisals.index');
        // Route::get('/appraisals/{appraisal}/fill', \App\Livewire\Staff\Appraisals\Fill::class)->name('appraisals.fill');
    });
});
